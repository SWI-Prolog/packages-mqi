use swipl_rs::{PrologServer, PrologTerm, QueryResult, ServerConfig};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match session.query(
        "limit(10, route(london, berlin, Path, Distance, Time))",
        None,
    )? {
