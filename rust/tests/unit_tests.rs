use swipl_rs::{PrologError, QueryResult, PrologTerm, PrologCompound};
use swipl_rs::types::{is_prolog_atom, is_prolog_variable, is_prolog_functor, prolog_name, prolog_args};
use serde_json::json;
...
fn test_error_display() {
    ...
    assert_eq!(format!("{}", config_err), "Configuration error: missing port");
...
fn test_prolog_term_to_string() {
    ...
    assert_eq!(prolog_term_to_string(&PrologTerm::Variable("_Var".to_string())), "_Var");
